...
const float stepcount = 15;  // No of pulses per complete rotation of motor shaft
const float wheeldiameter = 204; // Wheel diameter in millimeters, change if different
